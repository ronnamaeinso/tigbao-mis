<x-auth-layout title="Request Documents">
    ...
    <section class="container mt-4">
        {{-- request --}}
        <a href="{{route('request.documents.attestation.certificate.create')}}" class="btn btn-sm bg-primary-color">
            <x-icon type="plus" />
            Request
        </a>
        ...
        <div class="card mt-3 bg-white shadow-lg">
            <div class="card-header">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h5 class="m-0 primary-color">Request List - Certificate of Attestations</h5>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-sm table-hover">
                        <thead class="text-nowrap">
                            ...
                            <th class="primary-color">Work</th>
                            <th class="primary-color">Monthly Earning</th>
                        ...
                        <tbody>
                            ...
                            <tr class="align-middle">
                                ...
                                <td>{{$item->work}}</td>
                                <td>{{ 'PhP ' .(string) number_format($item->monthly_earning)}}</td>
                                <td>
                                    {!! $item->status == 1 ? '<small
