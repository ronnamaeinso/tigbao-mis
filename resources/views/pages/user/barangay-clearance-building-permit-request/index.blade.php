<x-auth-layout title="Barangay Clear - Building Permit">

    <section class="container mx-auto m-0 p-0">
        <a href="{{ route('barangay-clearance.building-permit.request.create') }}"
            class="btn btn-sm bg-primary-color mb-3">
            <x-icon type="plus" />
            Request
        </a>
            ...
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="m-0 primary-color">
                        <x-icon type="file" />
                        My Request List - Barangay Clearance - Building Permit
                    </h5>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="dropdown-item">
                                                <a href="{{ route('barangay-clearance.building-permit.request.index') }}"
                                            ...
                                            <li class="dropdown-item">
                                                <a href="{{ route('barangay-clearance.building-permit.request.index', ['status' => urlencode(1)]) }}"
                                            ...
                                            <li class="dropdown-item">
                                                <a href="{{ route('barangay-clearance.building-permit.request.index', ['status' => urlencode(2)]) }}"
                                            ...
                                            <li class="dropdown-item">
                                                <a href="{{ route('barangay-clearance.building-permit.request.index', ['status' => urlencode(3)]) }}"
                                            ...
                                            <li class="dropdown-item">
                                                <a href="{{ route('barangay-clearance.building-permit.request.index', ['status' => urlencode(4)]) }}"
                                            ...
                                            <li class="dropdown-item">
                                                <a href="{{ route('barangay-clearance.building-permit.request.index', ['status' => urlencode(5)]) }}"
                                                    class="nav-link text-primary">
                                            ...
                                            <li class="dropdown-item">
                                                <a href="{{ route('barangay-clearance.building-permit.request.index', ['status' => urlencode(6)]) }}"
                                                    class="nav-link text-success">
                                                    <x-icon type="file" />
                                                    Ready to claim
                                                </a>
                        ...
                        <tbody>
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('track.status', ['type' => urlencode('barangay-clearance-building-permit'), 'id' => urlencode($item->encrypted_id)]) }}"
