        ...
        <div class="card shadow">
            <div class="card-header">
                <h5 class="m-0 primary-color">
                    <x-icon type="plus" />
                    Request Certificate of Good Moral
                </h5>
            </div>
            <div class="card-body">
                {{-- form --}}
                <form action="{{ route('certificate-of-good-moral.request.store') }}" class="p-3 mx-auto" method="POST" style="width: 600px;">
                    @csrf
                    ...
                    <div class="d-flex align-items justify-content-end gap-2">
                        <a href="{{ route('certificate-of-good-moral.request.index') }}" class="btn btn-sm bg-primary-color">
