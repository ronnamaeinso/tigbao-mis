                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="d-flex align-items-center justify-content-between w-100">
                        <h5 class="m-0 primary-color">
                            ...
                            Request List - Certificate of Good Moral
                        </h5>
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="dropdown-item">
                                            <a href="{{ route('certificate-of-good-moral.request.list.index') }}"
                                        ...
                                        <li class="dropdown-item">
                                            <a href="{{ route('certificate-of-good-moral.request.list.index', ['status' => urlencode(1)]) }}"
                                        ...
                                        <li class="dropdown-item">
                                            <a href="{{ route('certificate-of-good-moral.request.list.index', ['status' => urlencode(2)]) }}"
                                        ...
                                        <li class="dropdown-item">
                                            <a href="{{ route('certificate-of-good-moral.request.list.index', ['status' => urlencode(4)]) }}"
                                        ...
                                        <li class="dropdown-item">
                                            <a href="{{ route('certificate-of-good-moral.request.list.index', ['status' => urlencode(5)]) }}"
                                                class="nav-link text-primary">
                                        ...
                                        <li class="dropdown-item">
                                            <a href="{{ route('certificate-of-good-moral.request.list.index', ['status' => urlencode(6)]) }}"
                                                class="nav-link text-success">
                                                <x-icon type="file" />
                                                Ready to claim
                                            </a>
                            ...
                            @forelse ($data as $item)
                                <tr class="align-middle">
                                    <td>
                                        ...
                                        @if ($item->status == 2)
                                            <form
                                                action="{{ route('certificate-of-good-moral.request.list.update', ['list' => urlencode($item->encrypted_id)]) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                        ...
                                        @if ($item->status == 4)
                                            ...
                                            <a href="/good-moral/{{ urlencode($item->encrypted_id) }}"
                        ...
                        if (result.isConfirmed) {
                            try {
                                const response = await axios.put(
                                    `/certificate-of-good-moral/request/list/${encodeURIComponent(id)}`, {
