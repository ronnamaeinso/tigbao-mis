    ...
    <section class="container mt-4">
        ...
        <div class="card mt-3 bg-white shadow-lg">
                ...
                <div class="d-flex align-items-center gap-2">
                    <div class="d-flex align-items-center justify-content-between w-100">
                        <h5 class="m-0 primary-color">
                            ...
                            Request List - Barangay Clearance Building Permit
                        </h5>
            ...
            <div class="card-body">
                            ...
                            <th class="primary-color">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown-item">
                                            <a href="{{ route('barangay-clearance.building-permit.request.list.index', ['status' => urlencode(1)]) }}"
                                        ...
                                        <li class="dropdown-item">
                                            <a href="{{ route('barangay-clearance.building-permit.request.list.index', ['status' => urlencode(2)]) }}"
                                        ...
                                        <li class="dropdown-item">
                                            <a href="{{ route('barangay-clearance.building-permit.request.list.index', ['status' => urlencode(4)]) }}"
                                        ...
                                        <li class="dropdown-item">
                                            <a href="{{ route('barangay-clearance.building-permit.request.list.index', ['status' => urlencode(5)]) }}"
                                                class="nav-link text-primary">
                                        ...
                                        <li class="dropdown-item">
                                            <a href="{{ route('barangay-clearance.building-permit.request.list.index', ['status' => urlencode(6)]) }}"
                                                class="nav-link text-success">
                                                <x-icon type="file" />
                                                Ready to claim
                                            </a>
                            ...
                            @forelse ($data as $item)
                                <tr class="align-middle">
                                    <td>
                                        ...
                                        @if ($item->status == 2)
                                            <form
                                                action="{{ route('barangay-clearance.building-permit.request.list.update', ['list' => urlencode($item->encrypted_id)]) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                        ...
                                        @if ($item->status == 4)
                                            ...
                                            <a href="/building-permit/{{ urlencode($item->encrypted_id) }}"
                ...
                @if ($data->lastPage() != 1)
                    <div
                        class="d-flex justify-content-sm-between justify-content-center align-items-center gap-2 flex-wrap">
                        ...
                        <div class="d-flex align-items-scenter gap-2">
                            <a href="{{ $data->previousPageUrl() }}"
                                class="btn btn-sm bg-primary-color fw-medium {{ $data->currentPage() == 1 ? 'disabled' : '' }}">
                                < Prev</a>
                                    <a href="{{ $data->nextPageUrl() }}"
                                        class="btn btn-sm bg-primary-color fw-medium {{ $data->currentPage() == $data->lastPage() ? 'disabled' : '' }}">Next
                                        ></a>
                        </div>
                    </div>
                @endif
                        ...
                        if (result.isConfirmed) {
                            try {
                                const response = await axios.put(
                                    `/barangay-clearance/building-permit/request/list/${encodeURIComponent(id)}`, {
