...
class BarangayClearanceBuildingPermitRequestListController extends Controller
{
    /**
     * index
     */
    public function index(): View
    {
        ...
        $data_query = BarangayClearanceBuildingPermitRequest::orderBy('created_at')->whereNot('status', 3);
        ...
        return view('pages.admin-staff.barangay-clearance-building-permit-request-list.index', [
            'data' => $data
        ]);
    }
    ...
    {
        $row = BarangayClearanceBuildingPermitRequest::findOrFail($id);
